...
namespace IdentitiesService.Repository
{
    public class ApplicationRepository : IApplicationRepository
    {
        ...
        public dynamic GetApplication(int id, Pagination pageInfo)
        {
            ...
            try
            {
                List<ApplicationsDto> ApplicationsModelList = new List<ApplicationsDto>();
                if (id == 0)
                {
        ...
        public dynamic PostApplication(ApplicationsDto model)
        {
            try
            {
                if (model == null)
        ...
        public dynamic PutApplication(ApplicationsDto model)
        {
            try
            {
                if (model == null)
