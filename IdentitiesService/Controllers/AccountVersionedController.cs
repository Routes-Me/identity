...
namespace IdentitiesService.Controllers
{
    ...
    public class AccountVersionedController : ControllerBase
    {
        private readonly IAccountRepository _accountRepository;
        private static readonly HttpClient HttpClient = new HttpClient();
        private readonly IdentitiesServiceContext _context;
        public AccountVersionedController(IAccountRepository accountRepository, IdentitiesServiceContext context)
        {
